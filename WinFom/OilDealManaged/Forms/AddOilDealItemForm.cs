...
{
    public partial class AddOilDealItemForm : Form
    {
        public int ItemId = 0;
        public AddOilDealItemForm()
        {
            InitializeComponent();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var obj = db.OilDealItems.ToList().FirstOrDefault(a => a.Title.ToLower().Equals(itemName.ToLower()));
                    if(obj != null)
                    {
                    ...
                    using (var trans = db.Database.BeginTransaction())
                    {
                        ...
                        GeneralAccount itemAccount = new GeneralAccount
                        {
                            ...
                            Title = acctStr,
                            Description = acctStr,
                            SubHeadAccountId = Properties.Resources.OilSalesSubHead
                        };
