...
{
    public partial class AddOilSelectorForm : Form
    {
        WebCam webcam = null;
        public OilDealSelector selector = null;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OilDealSelector selector2 = new OilDealSelector
                {
                ...
                {
                    var obj = db.OilDealSelectors.FirstOrDefault(a => a.CNIC.Equals(selector2.CNIC));
                    if(obj != null)
                    {
                    ...
                    selector = db.OilDealSelectors.Add(selector2);
                    db.SaveChanges();
