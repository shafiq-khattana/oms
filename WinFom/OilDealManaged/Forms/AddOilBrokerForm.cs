...
{
    public partial class AddOilBrokerForm : Form
    {
        public int BrokerId = 0;
        public AddOilBrokerForm()
        {
            InitializeComponent();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OilDealBroker comp = new OilDealBroker
                {
                ...
                using (Context db = new Context())
                {
                    ...
                    using (var trans = db.Database.BeginTransaction())
                    {
                        ...
                        {
                            string na = "N/A";
                            string acctTitle = string.Format("{0} (oil broker) account", comp.Name);
                            ...
                            string acctTitle2 = string.Format("{0} (oil brokery expense) account", comp.Name);
                            ...
                            comp = db.OilDealBrokers.Add(comp);
                            db.SaveChanges();
