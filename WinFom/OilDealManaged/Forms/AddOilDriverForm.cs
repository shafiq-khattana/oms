...
{
    public partial class AddOilDriverForm : Form
    {
        WebCam webcam = null;
        public OilDealDriver driver = null;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OilDealDriver driver2 = new OilDealDriver
                {
                ...
                {
                    var obj = db.OilDealSelectors.FirstOrDefault(a => a.CNIC.Equals(driver2.CNIC));
                    if(obj != null)
                    {
                    ...
                    driver = db.OilDealDrivers.Add(driver2);
                    db.SaveChanges();
