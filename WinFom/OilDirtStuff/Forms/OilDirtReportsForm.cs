...
{
    public partial class OilDirtReportsForm : Form
    {
        private AppSettings appSett = Helper.AppSet;
        public OilDirtReportsForm()
        {
            InitializeComponent();
        }
        ...
        List<OilDirtBroker> brokers = null;
        ...
        private void LoadTrialData()
        {
            ...
            {
                brokers = db.OilDirtBrokers.Where(a => !a.Name.Equals("N/A")).OrderBy(a => a.Name).ToList();
        ...
        private void btnTrialBalance_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                RCompRVM compvm = new RCompRVM
                {
                    ...
                    RepTitle = "Oil dirt brokers trial balances"
                };
