...
{
    public partial class AddOilDirtDriverForm : Form
    {
        WebCam webcam = null;
        public OilDirtDriver driver = null;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OilDirtDriver driver2 = new OilDirtDriver
                {
                ...
                {
                    var obj = db.OilDirtDrivers.FirstOrDefault(a => a.CNIC.Equals(driver2.CNIC));
                    if(obj != null)
                    {
                    ...
                    driver = db.OilDirtDrivers.Add(driver2);
                    db.SaveChanges();
