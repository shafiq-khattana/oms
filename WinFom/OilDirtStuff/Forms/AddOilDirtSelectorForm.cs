...
{
    public partial class AddOilDirtSelectorForm : Form
    {
        WebCam webcam = null;
        public OilDirtSelector selector = null;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OilDirtSelector selector2 = new OilDirtSelector
                {
                ...
                {
                    var obj = db.OilDirtSelectors.FirstOrDefault(a => a.CNIC.Equals(selector2.CNIC));
                    if(obj != null)
                    {
                        throw new Exception("Selector already added in database");
                    }
                    ...
                    selector = db.OilDirtSelectors.Add(selector2);
                    db.SaveChanges();

                    Gujjar.InfoMsg("Selector is added in database successfully");
                    Close();
                }
            }
            catch (Exception exp)
