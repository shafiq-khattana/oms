...
{
    public partial class FinancialExpenseForm : Form
    {
        ...
        private void LoadEntries()
        {
            try
            {
                ...
                using (Context db = new Context())
                {
                    if(isDated)
                    {
                        expenseEntries = db.ExpenseItemEntries.Where(a => a.ExpenseType == ExpenseType.Financial)
                            .AsParallel().ToList()
        ...
        private void btnAddExpense_Click(object sender, EventArgs e)
        {
            try
            {
                AddFinancialExpenseEntryForm form = new AddFinancialExpenseEntryForm(ExpenseType.Financial);
                form.ShowDialog();
