...
{
    public partial class CashAccountForm : Form
    {
        ...
        private void LoadTransactions()
        {
            try
            {
                ...
                {
                    transactions = db.AccountTransactions.Where(a => a.GeneralAccountId == Properties.Resources.CashInHand)
                        .AsParallel().ToList()
