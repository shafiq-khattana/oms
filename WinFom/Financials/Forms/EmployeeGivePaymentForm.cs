...
namespace WinFom.Financials.Forms
{
    ...
    public partial class EmployeeGivePaymentForm : Form
    {
        ...
        public EmployeeGivePaymentForm(string acctId)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                using (Context db = new Context())
                {
                    using (var trans = db.Database.BeginTransaction())
                    {
                        ...
                        string finMsg = string.Format("Employee payment paid: ({0}). Amount ({1}). Remarks ({2}), ({3}). By ({4})", debitAccount.Title, 
                        ...
                        Gujjar.InfoMsg("Payment is paid and record is stored in database successfully");
                        IsDone = true;
                        Close();
