...
{
    public partial class AddItemDamageRecordForm : Form
    {
        private int itemId = 0;
        private string itemName = "";
        public bool IsDone { get; set; }
        public AddItemDamageRecordForm(int repItemId, string itemName)
        {
            InitializeComponent();
            itemId = repItemId;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    RepItemDamageRecord record = new RepItemDamageRecord
                    {
                        Dated = dtp.Value,
                        Id = 0,
                        Item = null,
                    ...
                    db.RepItemDamageRecords.Add(record);
                    db.SaveChanges();
                    IsDone = true;
